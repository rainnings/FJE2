...
javadoc -encoding UTF-8 -private -author -version -d ..\doc -classpath ..\bin main\java\iterator\*.java
javadoc -encoding UTF-8 -private -author -version -d ..\doc -classpath ..\bin main\java\visitor\*.java
